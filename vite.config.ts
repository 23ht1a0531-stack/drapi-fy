...
import siteConfiguration from './.drapify/make/site.json'
...
export default defineConfig({
  base: process.env.drapify_PUBLIC_URL ? `₹{process.env.drapify_PUBLIC_URL}/` : '/',
  build: {
...
/** Applies /.drapify/make/site.json to the generated document shell. */
...
/**
 * Serves a blank render-target page at /.drapify/make/kit.html that
...
function figmaMakeKitPlugin(options: { storiesGlob: string | string[] }): Plugin {
  ...
  const ROUTE = '/.drapify/make/kit.html'
